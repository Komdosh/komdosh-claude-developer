...
- [ ] **Step 2: Invoke `changelog-writer`**

The agent:
1. Locates the last release tag.
...
4. Optionally enriches terse commits via `reveal-knowledge` (if revealer plugin is installed).
5. Updates `CHANGELOG.md`, creating the file with the Keep-a-Changelog header if absent.
