...
State which checks came back clean. Hand SA-key/secret findings to `secrets-sentinel` and plan-level replace hazards to `terraform-reviewer`/`verify-plan-safety`.
