...
This rule is loaded by every command and agent in `komdosh-dev-spring-core`.
...
- [`komdosh-dev-spring-core/rules/event-consumers.md`](../../komdosh-dev-spring-core/rules/event-consumers.md) — topic naming, the consuming side, the "version the topic, not the message" rule.
