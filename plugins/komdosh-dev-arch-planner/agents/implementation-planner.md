...
- "Break one feature into a within-service spec" — that's `requirements-analyst` (core). You plan **entire services** from architecture evidence.
...
| One todo needs a within-service spec | `requirements-analyst` (core) |
